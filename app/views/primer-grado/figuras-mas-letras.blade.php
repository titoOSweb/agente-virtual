	...
	<div class="nicdark_filter greydark">
		...
		<div class="nicdark_container nicdark_clearfix">
			...
			<div class="grid grid_12">
				...
				<h3 class="subtitle white">FIGURAS MÁS LETRAS</h3>
	...
	<div class="nicdark_container nicdark_clearfix">
		...
		<div class="grid grid_8">
			...
			<div class="row">
				...
				<div id="imagen" class="grid grid_8 center" align="center"></div>


				<div class="grid grid_8 center" align="center">
					<hr>
					<a href="#" class="dnd extrasize nicdark_width50 nicdark_btn nicdark_bg_blue medium nicdark_shadow nicdark_radius white nicdark_margin10" data-vocal="A">A</a>
					<a href="#" class="dnd extrasize nicdark_width50 nicdark_btn nicdark_bg_red medium nicdark_shadow nicdark_radius white nicdark_margin10" data-vocal="E">E</a>
					<a href="#" class="dnd extrasize nicdark_width50 nicdark_btn nicdark_bg_yellow medium nicdark_shadow nicdark_radius white nicdark_margin10" data-vocal="I">I</a>
					<a href="#" class="dnd extrasize nicdark_width50 nicdark_btn nicdark_bg_orange medium nicdark_shadow nicdark_radius white nicdark_margin10" data-vocal="O">O</a>
					<a href="#" class="dnd extrasize nicdark_width50 nicdark_btn nicdark_bg_green medium nicdark_shadow nicdark_radius white nicdark_margin10" data-vocal="U">U</a>
				</div>
...
this.handleDrop = function(e) {
    ...
    if (dragSrcEl_ != this) {
    	...
    	if(dragSrcEl_.getAttribute('data-vocal') == this.getAttribute('data-vocal')){
    		dragSrcEl_.remove();
