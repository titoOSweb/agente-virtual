            ...
            <div class="col-sm-6 col-md-4 col-sm-offset-3 col-md-offset-4">
                ...
                <div class="login-box clearfix animated flipInY">
                    ...
                    <div class="login-form">
                        ...
                        <form action="/auth/forgot" method="post" id="login">

                            <p>Introduzca su dirección de correo electrónico y te enviaremos un enlace especial de restablecimiento de contraseña a su bandeja de entrada.</p>
                            <input type="email" name="email" placeholder="Email" class="input-field" required/>
                            <button type="submit" class="btn btn-login btn-reset">Restablecer</button>
                        </form>
