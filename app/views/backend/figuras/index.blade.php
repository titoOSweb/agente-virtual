...
<div id="main-content">
    ...
    <div class="page-title"> <i class="icon-custom-left"></i>
        ...
        <a href="/dashboard/figuras/create" class="btn btn-success pull-right m-20"> Nueva palabra </a>
    </div>
    <div class="row">
        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12 table-responsive table-blue filter-right">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-hover table-dynamic">
                                ...
                                <tbody>
                                    @foreach ($figuras as $key => $figura)      
                                    <tr>
                                        <td>{{ $figura->id }}</td>
                                        <td>{{ $figura->palabra }}</td>
                                        <td>
                                            <img class="img-responsive imgg" src="{{ $figura->imagen }}" alt="">
                                        </td>
                                        <td><a href="/dashboard/silabas/{{ $figura->id }}/delete" class="btn btn-danger">Eliminar</a></td>
                                    </tr>
                                    @endforeach                                           
