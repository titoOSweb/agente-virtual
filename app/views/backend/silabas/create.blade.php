                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <h4>&bull; <a href="/primer-grado/adivina-la-palabra" target="_blank">Adivina la palabra</a> &bull;<a href="/primer-grado/formando-palabras" target="_blank"> Formando palabras</a> &bull; <a href="/tercer-grado/silabas" target="_blank">Sílabas</a></h4>
                            <!-- BEGIN FORM WIZARD WITH VALIDATION -->
                            <form class="form-wizard" action="/dashboard/silabas" method="POST">
                                 <h1>Imagen</h1>
                                <section>
                                    <div class="col-md-12">
                                ...
                                <section>
                                    <div class="form-group col-md-12">
                                        ...
                                        <input id="palabra" name="palabra" type="text" class="form-control required" placeholder="COMPUTADORA">
                                    </div>

                                    <div class="form-group col-md-12">
                                        <label for="country_id">Sílabas *</label>
                                        <input id="silabas" name="silabas" type="text" class="form-control required" placeholder="COM-PU-TA-DO-RA">
                                    </div> 
