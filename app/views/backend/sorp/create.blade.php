                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <h4>&bull; <a href="/segundo-grado/singular-y-plural" target="_blank">Singular y plural</a> </h4>
                            <!-- BEGIN FORM WIZARD WITH VALIDATION -->
                            <form class="form-wizard" action="/dashboard/sorp" method="POST">
                                 <h1>Imagen</h1>
                                <section>
                                    <div class="col-md-12">
                                ...
                                <section>
                                    ...
                                    <div class="form-group col-md-12">
                                        <label for="country_id">Singular o plural *</label>
                                        <select class="form-control" data-style="input-sm btn-default" name="sorp">
