            ...
            <div class="nicdark_container nicdark_clearfix">
                ...
                <div class="grid grid_6 right">
                    <div class="nicdark_focus right">
                        <h6 class="white">
                            <i class="icon-globe-alt-outline"></i>&nbsp;&nbsp;<a class="white nicdark_mpopup_window" href="single-product.php#nicdark_window">LANGUAGES</a>
                            &nbsp;&nbsp;&nbsp;&nbsp;<span class="grey">·</span>&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div class="grid grid_12 percentage">
                        ...
                        <nav>
                            <ul class="nicdark_menu nicdark_margin010 nicdark_padding50">
                                ...
                                <li class="orange">
                                    <a href="single-product.php#">PAGES</a>
                                    <ul class="sub-menu">
                                ...
                                <li class="blue nicdark_megamenu">
                                    <a href="single-product.php#">MEGA MENU</a>
                                    <ul class="sub-menu">
                                        ...
                                        <li class="mm_grid mm_grid_3">
                                            <a href="single-product.php#">DEDICATED PAGES</a>
                                            <ul class="sub-menu">
                                                <li><a href="single-course.php">Single Course</a></li>
                                                <li><a href="single-excursion.php">Single Excursion</a></li>
                                                <li><a href="single-event.php">Single Event</a></li>
                                        ...
                                        <li class="mm_grid mm_grid_3">
                                            <a href="single-product.php#">SPECIAL PAGES</a>
                                            <ul class="sub-menu">
    ...
    <div class="nicdark_filter greydark">
        ...
        <div class="nicdark_container nicdark_clearfix">
            ...
            <div class="grid grid_12">
                ...
                <div class="nicdark_space100"></div>
                <h1 class="white subtitle">SINGLE PRODUCT</h1>
                <div class="nicdark_space10"></div>
...
<section class="nicdark_section">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_6">
            ...
            <div class="nicdark_archive1 nicdark_radius">
                ...
                <div class="nicdark_mpopup_gallery">
                    <a href="img/shop/img1.jpg" title="IMAGE EXAMPLE"><img alt="" class="nicdark_radius nicdark_opacity" src="img/shop/img1.jpg"></a>
                </div>
        ...
        <div class="grid grid_6">
            <!--title-->
            <h2 class="subtitle greydark">CHILDREN BOOK</h2>
            <div class="nicdark_space20"></div>
            <div class="nicdark_divider left small"><span class="nicdark_bg_green nicdark_radius"></span></div>
            <!--title--> 
            <div class="nicdark_space40"></div>
            <h3><i class="icon-star yellow"></i><i class="icon-star yellow"></i><i class="icon-star yellow"></i><i class="icon-star yellow"></i><i class="icon-star-half-alt yellow"></i></h3>
            <div class="nicdark_space20"></div>
            <h4 class="subtitle grey"><a class="grey nicdark_internal_link" href="single-product.php#nicdark_reviews">( CUSTOMER REVIEWS 3 )</a></h4>
            <div class="nicdark_space40"></div>
            <h1 class="subtitle green"><span class="grey nicdark_strike">500,00 $</span> - 250,00 $</h1>
            <div class="nicdark_space40"></div>
            ...
            <div class="nicdark_space40"></div>
            <a href="shop-cart.php" class="white nicdark_btn nicdark_bg_green  medium nicdark_radius nicdark_shadow nicdark_press">ADD TO CART</a>
            <div class="nicdark_space40"></div>

            <div class="nicdark_textevidence nicdark_bg_grey nicdark_shadow nicdark_radius">
                <div class="nicdark_margin20">
                    <p>CATEGORIES: BOOK, LANGUAGES, CHILDREN</p>
               </div>
...
<section class="nicdark_section">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div id="nicdark_reviews" class="nicdark_space40"></div>
           ...
           <!--start nicdark_tabs-->
            <div class="nicdark_tab">
                ...
                <ul class="nicdark_tabslist">
                    <li><a href="single-product.php#tabs-1" class="nicdark_btn nicdark_bg_blue medium nicdark_radius_top white"><i class="icon-info-1 nicdark_marginright10 nicdark_displaynone_ipadpotr nicdark_displaynone_iphonepotr"></i>DESCRIPTION</a></li>
                    <li><a href="single-product.php#tabs-2" class="nicdark_btn nicdark_bg_green medium nicdark_radius_top white"><i class="icon-star nicdark_marginright10 nicdark_displaynone_ipadpotr nicdark_displaynone_iphonepotr"></i>REVIEWS (3)</a></li>
                </ul>
...
<section class="nicdark_section">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_12">
            <!--title-->
            <h3 class="subtitle greydark">RELATED PRODUCTS</h3>
            <div class="nicdark_space20"></div>
            <div class="nicdark_divider left small"><span class="nicdark_bg_green nicdark_radius"></span></div>
            <!--title--> 
        </div>
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_3">
            ...
            <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                ...
                <a href="single-product.php" class="nicdark_btn nicdark_bg_green white medium nicdark_radius nicdark_absolute_left nicdark_shadow nicdark_bg_greendark_hover nicdark_transition">SALE</a>

                <img alt="" src="img/shop/img1.jpg">

                <div class="nicdark_textevidence nicdark_bg_greydark">
                    <h4 class="white nicdark_margin20">HISTORY</h4>
                </div>
                ...
                <div class="nicdark_textevidence">
                    <div class="nicdark_margin20">
                        <p>$ 721.00</p>
                        <div class="nicdark_space20"></div>
                        <a href="single-product.php" class="grey nicdark_btn nicdark_bg_grey2  medium nicdark_radius nicdark_shadow nicdark_press"><i class="icon-basket"></i>&nbsp;&nbsp;&nbsp;ADD TO CART</a>
                    </div>
                </div>
        ...
        <div class="grid grid_3">
            ...
            <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                ...
                <img alt="" src="img/shop/img2.jpg">

                <div class="nicdark_textevidence nicdark_bg_greydark">
                    <h4 class="white nicdark_margin20">GEOGRAPHY</h4>
                </div>
...
<section class="nicdark_section nicdark_bg_greydark">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_3 nomargin percentage">
            ...
            <a href="single-product.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
            <a href="single-product.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Baby</a>
            <a href="single-product.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Kids</a>
            <a href="single-product.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
            <a href="single-product.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
            <a href="single-product.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Baby</a>
            <a href="single-product.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Kids</a>
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_6">
            <div class="nicdark_focus right nicdark_aligncenter_iphoneland nicdark_aligncenter_iphonepotr">
                <div class="nicdark_margin10">
                    <a href="single-product.php#" class="nicdark_facebook nicdark_press right nicdark_btn_icon small nicdark_radius white"><i class="icon-facebook-1"></i></a>
                </div>
                <div class="nicdark_margin10">
                    <a href="single-product.php#" class="nicdark_press right nicdark_btn_icon nicdark_bg_red nicdark_shadow small nicdark_radius white"><i class="icon-gplus"></i></a>
                </div>
                <div class="nicdark_margin10">
                    <a href="single-product.php#" class="nicdark_press right nicdark_btn_icon nicdark_bg_blue nicdark_shadow small nicdark_radius white"><i class="icon-twitter-1"></i></a>
                </div>
                <div class="nicdark_margin10">
                    <a href="single-product.php#start_nicdark_framework" class="nicdark_zoom nicdark_internal_link right nicdark_btn_icon nicdark_bg_greydark2 small nicdark_radius white"><i class="icon-up-outline"></i></a>
                </div>
            </div>
        </div>
