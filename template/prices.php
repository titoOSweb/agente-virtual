            ...
            <div class="nicdark_container nicdark_clearfix">
                ...
                <div class="grid grid_6 right">
                    <div class="nicdark_focus right">
                        <h6 class="white">
                            <i class="icon-globe-alt-outline"></i>&nbsp;&nbsp;<a class="white nicdark_mpopup_window" href="prices.php#nicdark_window">LANGUAGES</a>
                            &nbsp;&nbsp;&nbsp;&nbsp;<span class="grey">·</span>&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <ul class="nicdark_menu nicdark_margin010 nicdark_padding50">
                                ...
                                <li class="blue nicdark_megamenu">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="mm_grid mm_grid_3">
                                            <a href="prices.php#">DEDICATED PAGES</a>
                                            <ul class="sub-menu">
                                                <li><a href="single-course.php">Single Course</a></li>
                                                <li><a href="single-excursion.php">Single Excursion</a></li>
                                                <li><a href="single-event.php">Single Event</a></li>
                                        ...
                                        <li class="mm_grid mm_grid_3">
                                            <a href="prices.php#">SPECIAL PAGES</a>
                                            <ul class="sub-menu">
...
<section class="nicdark_section nicdark_bg_yellow nicdark_shadow">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_4 nomargin nicdark_bg_yellow nicdark_bg_yellowdark_hover nicdark_transition nicdark_shadow nicdark_radius_left">
        ...
        <div class="grid grid_4 nomargin nicdark_bg_orange nicdark_bg_orangedark_hover nicdark_transition nicdark_shadow">
        ...
        <div class="grid grid_4 nomargin nicdark_bg_yellow nicdark_bg_yellowdark_hover nicdark_transition nicdark_shadow nicdark_radius_right">
...
<section class="nicdark_section">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_12">
            <h1 class="subtitle greydark">MAIN PACKAGES</h1>
            <div class="nicdark_space20"></div>
            <h3 class="subtitle grey">CHOOSE THE BEST PACKAGE FOR YOUR KIDS</h3>
            <div class="nicdark_space20"></div>
            ...
            <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                ...
                <div class="nicdark_textevidence nicdark_bg_blue nicdark_radius nicdark_width_percentage50 center nicdark_width100_responsive">
                    <div class="nicdark_margin20">
                        ...
                        <h1 class="white subtitle">$ 123.00</h1>
                        <div class="nicdark_space20"></div>
                    ...
                    <i class="icon-money-1 nicdark_iconbg left big blue"></i>
                </div>
                ...
                <div class="nicdark_textevidence nicdark_width_percentage50 nicdark_width100_responsive">
                    <div class="nicdark_margin20">
                        ...
                        <div class="nicdark_space20"></div>
                        <h4 class="grey">FULL TIME / AGE 0-3</h4>                        
                        <div class="nicdark_space20"></div>
                ...
                <a href="prices.php#" class="nicdark_btn_icon small nicdark_bg_white nicdark_radius_circle nicdark_absolute_right nicdark_border_grey"></a>
        ...
        <div class="grid grid_6">
            <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                ...
                <div class="nicdark_textevidence nicdark_bg_green nicdark_radius nicdark_width_percentage50 center nicdark_width100_responsive">
                    <div class="nicdark_margin20">
                ...
                <div class="nicdark_textevidence nicdark_width_percentage50 nicdark_width100_responsive">
                    <div class="nicdark_margin20">
                        ...
                        <div class="nicdark_space20"></div>
                        <h4 class="grey">HALF TIME / AGE 0-3</h4>                        
                        <div class="nicdark_space20"></div>
                        <p>Lorem ipsum dolor sit amet, ipsum dolor sit amet, ipsum dolor sit amet, ipsum dolor sit amet. Lorem ipsum dolor sit amet.</p>
        ...
        <div class="grid grid_6">
            <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                ...
                <div class="nicdark_textevidence nicdark_bg_violet nicdark_radius nicdark_width_percentage50 center nicdark_width100_responsive">
                    <div class="nicdark_margin20">
                    
                        <div class="nicdark_space30"></div>
                    
                        <h1 class="white subtitle">$ 100.00</h1>
                        <div class="nicdark_space20"></div>
                        <div class="nicdark_divider small"><span class="nicdark_bg_white nicdark_radius"></span></div>
                        <div class="nicdark_space20"></div>
                        <h4 class="white subtitle">MONTHLY</h4>
                    ...
                    <i class="icon-money-1 nicdark_iconbg left big violet"></i>
                </div>
                ...
                <div class="nicdark_textevidence nicdark_width_percentage50 nicdark_width100_responsive">
                    <div class="nicdark_margin20">
                        ...
                        <div class="nicdark_space20"></div>
                        <h4 class="grey">FULL TIME / AGE 3-6</h4>                        
                        <div class="nicdark_space20"></div>
                        <p>Lorem ipsum dolor sit amet, ipsum dolor sit amet, ipsum dolor sit amet, ipsum dolor sit amet. Lorem ipsum dolor sit amet.</p>
        ...
        <div class="grid grid_6">
            <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                ...
                <div class="nicdark_textevidence nicdark_bg_yellow nicdark_radius nicdark_width_percentage50 center nicdark_width100_responsive">
                    <div class="nicdark_margin20">
                    
                        <div class="nicdark_space30"></div>
                    
                        <h1 class="white subtitle">$ 250.00</h1>
                        <div class="nicdark_space20"></div>
                        <div class="nicdark_divider small"><span class="nicdark_bg_white nicdark_radius"></span></div>
                        <div class="nicdark_space20"></div>
                        <h4 class="white subtitle">QUARTERLY</h4>
                    ...
                    <i class="icon-money-1 nicdark_iconbg left big yellow"></i>
                </div>
                ...
                <div class="nicdark_textevidence nicdark_width_percentage50 nicdark_width100_responsive">
                    <div class="nicdark_margin20">
                        ...
                        <div class="nicdark_space20"></div>
                        <h4 class="grey">HALF TIME / AGE 3-6</h4>                        
                        <div class="nicdark_space20"></div>
                        <p>Lorem ipsum dolor sit amet, ipsum dolor sit amet, ipsum dolor sit amet, ipsum dolor sit amet. Lorem ipsum dolor sit amet.</p>
...
<!--start section-->
<section id="nicdark_parallax_text" class="nicdark_section nicdark_imgparallax nicdark_parallaxx_img2">
    ...
    <div class="nicdark_filter greydark">
        ...
        <div class="nicdark_container nicdark_clearfix">
            ...
            <div class="grid grid_12">
                <div class="nicdark_space40"></div>
                <div class="nicdark_space50"></div>
                <h1 class="white subtitle center">CUSTOM FOOD ?</h1>
                <div class="nicdark_space10"></div>
                <h3 class="subtitle white center">FACILITIES FOR CELIAC CHILDREN</h3>
                <div class="nicdark_space20"></div>
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_3">
            ...
            <div class="nicdark_archive1 center nicdark_bg_blue nicdark_shadow nicdark_radius">
                ...
                <div class="nicdark_textevidence nicdark_bg_greydark nicdark_radius_top">
                    <h4 class="white nicdark_margin20">MENU FOR CELIACS</h4>
                </div>
                ...
                <a href="prices.php#" class="white nicdark_btn nicdark_bg_blue medium nicdark_radius_bottom">BUTTON</a>
        ...
        <div class="grid grid_3">
            ...
            <div class="nicdark_archive1 center nicdark_bg_yellow nicdark_shadow nicdark_radius">
                ...
                <div class="nicdark_textevidence nicdark_bg_greydark nicdark_radius_top">
                    <h4 class="white nicdark_margin20">SHUTTLE SERVICE</h4>
                </div>


                <div style="background:url(img/prices/img2.jpg); background-size:cover;" class="nicdark_archive1">
                    <div class="nicdark_filter yellow">

                        <div class="nicdark_space40"></div>
                        
                        <h3 class="white subtitle">$ 20.00</h3>
                        <div class="nicdark_space20"></div>
                        <div class="nicdark_divider small"><span class="nicdark_bg_white nicdark_radius"></span></div>
                        <div class="nicdark_space20"></div>
                        <h4 class="white subtitle">MONTHLY</h4>
                ...
                <a href="prices.php#" class="white nicdark_btn nicdark_bg_yellow medium nicdark_radius_bottom">BUTTON</a>
        ...
        <div class="grid grid_3">
            ...
            <div class="nicdark_archive1 center nicdark_bg_green nicdark_shadow nicdark_radius">
                ...
                <div class="nicdark_textevidence nicdark_bg_greydark nicdark_radius_top">
                    <h4 class="white nicdark_margin20">SWIMMING COURSES</h4>
                </div>


                <div style="background:url(img/prices/img3.jpg); background-size:cover;" class="nicdark_archive1">
                    <div class="nicdark_filter green">

                        <div class="nicdark_space40"></div>
                        
                        <h3 class="white subtitle">$ 470.00</h3>
                        <div class="nicdark_space20"></div>
                        <div class="nicdark_divider small"><span class="nicdark_bg_white nicdark_radius"></span></div>
                        <div class="nicdark_space20"></div>
                        <h4 class="white subtitle">WHOLE SEASON</h4>
                ...
                <a href="prices.php#" class="white nicdark_btn nicdark_bg_green medium nicdark_radius_bottom">BUTTON</a>
        ...
        <div class="grid grid_3">
            ...
            <div class="nicdark_archive1 center nicdark_bg_red nicdark_shadow nicdark_radius">
                
                
                <div class="nicdark_textevidence nicdark_bg_greydark nicdark_radius_top">
                    <h4 class="white nicdark_margin20">PAINTING COURSES</h4>
                </div>


                <div style="background:url(img/prices/img4.jpg); background-size:cover;" class="nicdark_archive1">
                    <div class="nicdark_filter red">

                        <div class="nicdark_space40"></div>
                        
                        <h3 class="white subtitle">$ 115.00</h3>
                        <div class="nicdark_space20"></div>
                        <div class="nicdark_divider small"><span class="nicdark_bg_white nicdark_radius"></span></div>
                        <div class="nicdark_space20"></div>
                        <h4 class="white subtitle">MONTHLY</h4>
                ...
                <a href="prices.php#" class="white nicdark_btn nicdark_bg_red medium nicdark_radius_bottom">BUTTON</a>
...
<!--start section-->
<div id="nicdark_parallax_2_btns" class="nicdark_section nicdark_imgparallax nicdark_parallaxx_img3">
    ...
    <div class="nicdark_filter greydark">
        ...
        <div class="nicdark_container nicdark_clearfix">
            ...
            <div class="grid grid_6 nicdark_aligncenter_iphoneland nicdark_aligncenter_iphonepotr">
                <a href="courses.php" class="nicdark_disable_floatright_iphoneland nicdark_disable_floatright_iphonepotr nicdark_btn nicdark_bg_blue medium right nicdark_shadow nicdark_radius white nicdark_press"><i class="icon-lightbulb-1"></i>&nbsp;&nbsp;&nbsp;ALL COURSES</a>
            </div>
            <div class="grid grid_6 nicdark_aligncenter_iphoneland nicdark_aligncenter_iphonepotr">
...
<section class="nicdark_section nicdark_bg_greydark">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_3 nomargin percentage">
            ...
            <a href="prices.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
            <a href="prices.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Baby</a>
            <a href="prices.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Kids</a>
            <a href="prices.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
            <a href="prices.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
            <a href="prices.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Baby</a>
            <a href="prices.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Kids</a>
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_6">
            <div class="nicdark_focus right nicdark_aligncenter_iphoneland nicdark_aligncenter_iphonepotr">
                <div class="nicdark_margin10">
                    <a href="prices.php#" class="nicdark_facebook nicdark_press right nicdark_btn_icon small nicdark_radius white"><i class="icon-facebook-1"></i></a>
                </div>
                <div class="nicdark_margin10">
                    <a href="prices.php#" class="nicdark_press right nicdark_btn_icon nicdark_bg_red nicdark_shadow small nicdark_radius white"><i class="icon-gplus"></i></a>
                </div>
                <div class="nicdark_margin10">
                    <a href="prices.php#" class="nicdark_press right nicdark_btn_icon nicdark_bg_blue nicdark_shadow small nicdark_radius white"><i class="icon-twitter-1"></i></a>
                </div>
                <div class="nicdark_margin10">
                    <a href="prices.php#start_nicdark_framework" class="nicdark_zoom nicdark_internal_link right nicdark_btn_icon nicdark_bg_greydark2 small nicdark_radius white"><i class="icon-up-outline"></i></a>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
	jQuery(document).ready(function() {
        ...
        $('#nicdark_parallax_text').parallax("50%", 0.3);
