            ...
            <div class="nicdark_container nicdark_clearfix">
                ...
                <div class="grid grid_6 right">
                    <div class="nicdark_focus right">
                        <h6 class="white">
                            <i class="icon-globe-alt-outline"></i>&nbsp;&nbsp;<a class="white nicdark_mpopup_window" href="shop-cart.php#nicdark_window">LANGUAGES</a>
                            &nbsp;&nbsp;&nbsp;&nbsp;<span class="grey">·</span>&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <nav>
                            <ul class="nicdark_menu nicdark_margin010 nicdark_padding50">
                                ...
                                <li class="blue nicdark_megamenu">
                                    <a href="shop-cart.php#">MEGA MENU</a>
                                    <ul class="sub-menu">
                                        ...
                                        <li class="mm_grid mm_grid_3">
                                            <a href="shop-cart.php#">DEDICATED PAGES</a>
                                            <ul class="sub-menu">
                                                <li><a href="single-course.php">Single Course</a></li>
                                                <li><a href="single-excursion.php">Single Excursion</a></li>
                                                <li><a href="single-event.php">Single Event</a></li>
                                        ...
                                        <li class="mm_grid mm_grid_3">
                                            <a href="shop-cart.php#">SPECIAL PAGES</a>
                                            <ul class="sub-menu">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_12">
            ...
            <div class="nicdark_textevidence nicdark_shadow nicdark_radius_top left overflow_scroll">   
                <table class="nicdark_table extrabig nicdark_bg_orange nicdark_radius_top ">
                    ...
                    <tbody class="nicdark_bg_white nicdark_border_grey">
                        <tr>
                            <td><h1><a href="shop-cart.php#"><i class="icon-cancel-circled-1 red"></i></a></h1></td>
                            <td><img alt="" class="nicdark_radius nicdark_opacity" src="img/shop/img1.jpg" width="70"></td>
                        ...
                        <tr>
                            <td><h1><a href="shop-cart.php#"><i class="icon-cancel-circled-1 red"></i></a></h1></td>
                            <td><img alt="" class="nicdark_radius nicdark_opacity" src="img/shop/img2.jpg" width="70"></td>
                            <td><p>LOREM IPSUM</p></td>
                            <td><p>$ 40,00</p></td>
                            <td><p>2</p></td>
                            <td><p>$ 80,00</p></td>
                        ...
                        <tr>
                            <td><h1><a href="shop-cart.php#"><i class="icon-cancel-circled-1 red"></i></a></h1></td>
                            <td><img alt="" class="nicdark_radius nicdark_opacity" src="img/shop/img3.jpg" width="70"></td>
                            <td><p>LOREM IPSUM</p></td>
                            <td><p>$ 60,00</p></td>
                            <td><p>1</p></td>
                            <td><p>$ 60,00</p></td>
                        ...
                        <tr>
                            <td><h1><a href="shop-cart.php#"><i class="icon-cancel-circled-1 red"></i></a></h1></td>
                            <td><img alt="" class="nicdark_radius nicdark_opacity" src="img/shop/img4.jpg" width="70"></td>
                            <td><p>LOREM IPSUM</p></td>
                            <td><p>$ 50,00</p></td>
                            <td><p>2</p></td>
                            <td><p>$ 100,00</p></td>
            ...
            <div class="nicdark_textevidence nicdark_bg_grey nicdark_shadow right nicdark_radius_bottom">
                <div class="nicdark_space10"></div>
                <a href="shop-cart.php#" class="nicdark_btn nicdark_bg_red nicdark_bg_reddark_hover nicdark_transition medium nicdark_shadow nicdark_radius white nicdark_margin10"><i class="icon-spin3"></i>&nbsp;&nbsp;&nbsp;UPDATE CART</a>
                <a href="shop-checkout.php" class="nicdark_btn nicdark_bg_orange nicdark_transition nicdark_bg_orangedark_hover medium nicdark_shadow nicdark_radius white nicdark_margin10"><i class="icon-basket-1"></i>&nbsp;&nbsp;&nbsp;CHECKOUT</a>&nbsp;&nbsp;
                <div class="nicdark_space10"></div>
            </div>
        ...
        <div class="grid grid_6">
            <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                <div class="nicdark_textevidence nicdark_bg_blue nicdark_radius_top">
                    ...
                    <i class="icon-globe-1 nicdark_iconbg right medium blue"></i>
                </div>
                <div class="nicdark_margin20">
                    <p>ADDRESS:</p>
                    ...
                    <input class="nicdark_bg_grey2 nicdark_radius nicdark_shadow grey small subtitle" type="text" value="" size="200">
                    <div class="nicdark_space20"></div>
                    <input class="nicdark_btn nicdark_bg_blue medium nicdark_shadow nicdark_radius white nicdark_press" type="submit" value="UPDATE">
                </div>
            </div>    
        </div>
...
<section class="nicdark_section nicdark_bg_greydark">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_3 nomargin percentage">
            ...
            <a href="shop-cart.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
            <a href="shop-cart.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Baby</a>
            <a href="shop-cart.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Kids</a>
            <a href="shop-cart.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
            <a href="shop-cart.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
            <a href="shop-cart.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Baby</a>
            <a href="shop-cart.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Kids</a>
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_6">
            <div class="nicdark_focus right nicdark_aligncenter_iphoneland nicdark_aligncenter_iphonepotr">
                <div class="nicdark_margin10">
                    <a href="shop-cart.php#" class="nicdark_facebook nicdark_press right nicdark_btn_icon small nicdark_radius white"><i class="icon-facebook-1"></i></a>
                </div>
                <div class="nicdark_margin10">
                    <a href="shop-cart.php#" class="nicdark_press right nicdark_btn_icon nicdark_bg_red nicdark_shadow small nicdark_radius white"><i class="icon-gplus"></i></a>
                </div>
                <div class="nicdark_margin10">
                    <a href="shop-cart.php#" class="nicdark_press right nicdark_btn_icon nicdark_bg_blue nicdark_shadow small nicdark_radius white"><i class="icon-twitter-1"></i></a>
                </div>
                <div class="nicdark_margin10">
                    <a href="shop-cart.php#start_nicdark_framework" class="nicdark_zoom nicdark_internal_link right nicdark_btn_icon nicdark_bg_greydark2 small nicdark_radius white"><i class="icon-up-outline"></i></a>
                </div>
            </div>
        </div>
