            ...
            <div class="nicdark_container nicdark_clearfix">
                ...
                <div class="grid grid_6 right">
                    <div class="nicdark_focus right">
                        <h6 class="white">
                            <i class="icon-globe-alt-outline"></i>&nbsp;&nbsp;<a class="white nicdark_mpopup_window" href="components-focus.php#nicdark_window">LANGUAGES</a>
                            &nbsp;&nbsp;&nbsp;&nbsp;<span class="grey">·</span>&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div class="grid grid_12 percentage">
                        ...
                        <nav>
                            <ul class="nicdark_menu nicdark_margin010 nicdark_padding50">
                                ...
                                <li class="orange">
                                    <a href="components-focus.php#">PAGES</a>
                                    <ul class="sub-menu">
                                ...
                                <li class="blue nicdark_megamenu">
                                    <a href="components-focus.php#">MEGA MENU</a>
                                    <ul class="sub-menu">
                                        ...
                                        <li class="mm_grid mm_grid_3">
                                            <a href="components-focus.php#">DEDICATED PAGES</a>
                                            <ul class="sub-menu">
                                                <li><a href="single-course.php">Single Course</a></li>
                                                <li><a href="single-excursion.php">Single Excursion</a></li>
                                                <li><a href="single-event.php">Single Event</a></li>
                                        ...
                                        <li class="mm_grid mm_grid_3">
                                            <a href="components-focus.php#">SPECIAL PAGES</a>
                                            <ul class="sub-menu">
    ...
    <div class="nicdark_filter greydark">
        ...
        <div class="nicdark_container nicdark_clearfix">
            ...
            <div class="grid grid_12">
                ...
                <div class="nicdark_space100"></div>
                <h1 class="white subtitle">FOCUS SOLUTIONS</h1>
                <div class="nicdark_space10"></div>
                <h3 class="subtitle white">BUILT YOUR CUSTOM FOCUS</h3>
                <div class="nicdark_space20"></div>
...
<section class="nicdark_section">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_12">
            <h3 class="subtitle greydark">BASIC EXAMPLE</h3>
            <div class="nicdark_space20"></div>
        ...
        <div class="grid grid_4 fade-left animate1">
            
            <div class="nicdark_textevidence nicdark_bg_blue nicdark_shadow nicdark_radius">
                <div class="nicdark_margin20">
                    <h4 class="white">LOREM IPSUM DOLOR</h4>
                    <div class="nicdark_space20"></div>
                    <p class="white">Lroin elit arcu, rutrum commodo, vehicula tempus, commodo a, risus. Curabitur nec arcu. Donec sollicitudin mi sit amet mauris. Nam elementum quam</p>
                    <div class="nicdark_space20"></div>
                    <a href="components-focus.php#" class="nicdark_btn nicdark_press nicdark_bg_bluedark white medium nicdark_shadow nicdark_radius fade-down animate2">MORE</a>
               </div>
               <i class="icon-search-1 nicdark_iconbg right big blue"></i>
            </div>
        </div>

        <div class="grid grid_4 fade-up animate1">
            ...
            <div class="nicdark_textevidence nicdark_bg_green nicdark_shadow nicdark_radius">
                <div class="nicdark_margin20">
                    ...
                    <p class="white">Lroin elit arcu, rutrum commodo, vehicula tempus, commodo a, risus. Curabitur nec arcu. Donec sollicitudin mi sit amet mauris. Nam elementum quam</p>
                    <div class="nicdark_space20"></div>
                    <a href="components-focus.php#" class="nicdark_btn white nicdark_bg_greendark medium nicdark_shadow nicdark_radius fade-down animate3">MORE</a>
               </div>
                <i class="icon-search-1 nicdark_iconbg right big green"></i>
            </div>
        </div>

        <div class="grid grid_4 fade-right animate1">
            
            <div class="nicdark_textevidence nicdark_bg_violet nicdark_shadow nicdark_radius">
                <div class="nicdark_margin20">
                    <h4 class="white">LOREM IPSUM DOLOR</h4>
                    <div class="nicdark_space20"></div>
                    <p class="white">Lroin elit arcu, rutrum commodo, vehicula tempus, commodo a, risus. Curabitur nec arcu. Donec sollicitudin mi sit amet mauris. Nam elementum quam</p>
                    <div class="nicdark_space20"></div>
                    <a href="components-focus.php#" class="nicdark_btn white medium nicdark_bg_violetdark nicdark_shadow nicdark_radius fade-down animate4">MORE</a>
               </div>
                <i class="icon-search-1 nicdark_iconbg right big violet"></i>
            </div>
        </div>
        ...
        <div class="grid grid_12">
            <h3 class="subtitle greydark">SOME EXAMPLE</h3>
            <div class="nicdark_space20"></div>
            ...
            <div class="nicdark_margin10">
                <div class="grid grid_3 percentage">
                    <div class="nicdark_margin10 nicdark_relative">
                        <a href="components-focus.php#" class="nicdark_btn_icon nicdark_bg_green nicdark_shadow extrabig nicdark_radius_circle white nicdark_absolute nicdark_displaynone_ipadpotr"><i class="icon-diamond"></i></a>
                ...
                <div class="grid grid_3 percentage">
                    <div class="nicdark_margin10 nicdark_relative">
                        <a href="components-focus.php#" class="nicdark_btn_icon nicdark_bg_blue extrabig nicdark_shadow nicdark_radius_circle white nicdark_absolute nicdark_displaynone_ipadpotr"><i class="icon-diamond"></i></a>
                ...
                <div class="grid grid_3 percentage">
                    <div class="nicdark_margin10 nicdark_relative">
                        <a href="components-focus.php#" class="nicdark_btn_icon nicdark_bg_yellow extrabig nicdark_shadow nicdark_radius_circle white nicdark_absolute nicdark_displaynone_ipadpotr"><i class="icon-diamond"></i></a>
                ...
                <div class="grid grid_3 percentage">
                    <div class="nicdark_margin10 nicdark_relative">
                        <a href="components-focus.php#" class="nicdark_btn_icon nicdark_bg_orange extrabig nicdark_shadow nicdark_radius_circle white nicdark_absolute nicdark_displaynone_ipadpotr"><i class="icon-diamond"></i></a>
        ...
        <div class="grid grid_4">
            ...
            <div class="nicdark_archive1 nicdark_bg_greydark nicdark_radius nicdark_shadow">
                <div class="nicdark_margin20 nicdark_relative">
                        ...
                        <a href="components-focus.php#" class="nicdark_displaynone_ipadpotr nicdark_btn_icon nicdark_bg_greydark2 extrabig nicdark_radius_circle white nicdark_absolute nicdark_shadow"><i class="icon-diamond"></i></a>
        ...
        <div class="grid grid_4">
            ...
            <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                <div class="nicdark_margin20 nicdark_relative">
                        ...
                        <a href="components-focus.php#" class="nicdark_displaynone_ipadpotr nicdark_btn_icon nicdark_bg_red extrabig nicdark_radius_circle white nicdark_absolute nicdark_shadow"><i class="icon-paper-plane-1"></i></a>
        ...
        <div class="grid grid_4">
            ...
            <div class="nicdark_archive1 nicdark_bg_yellow nicdark_radius nicdark_shadow">
                <div class="nicdark_margin20 nicdark_relative">
                        ...
                        <a href="components-focus.php#" class="nicdark_displaynone_ipadpotr nicdark_btn_icon nicdark_bg_yellowdark extrabig nicdark_radius_circle white nicdark_absolute nicdark_shadow"><i class="icon-paper-plane-1"></i></a>
        ...
        <div class="grid grid_12">
            <h3 class="subtitle greydark">WITHOUT MARGIN + FULL WIDTH</h3>
            <div class="nicdark_space20"></div>
...
<section class="nicdark_section nicdark_bg_yellow nicdark_shadow">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_4 nomargin nicdark_bg_yellow nicdark_shadow nicdark_radius_left">
            ...
            <div class="nicdark_focus">
                <div class="nicdark_margin10">
                    ...
                    <p class="white">Lroin elit arcu, rutrum commodo, vehicula tempus, commodo a, risus. Curabitur nec arcu. Donec sollicitudin mi sit amet mauris. Nam elementum quam</p>
                    <div class="nicdark_space20"></div>
                    <a href="components-focus.php#" class="nicdark_btn white medium nicdark_bg_yellowdark nicdark_shadow nicdark_radius">MORE</a>
               </div>
            </div>
        </div>

        <div class="grid grid_4 nomargin nicdark_bg_orange nicdark_shadow">
            ...
            <div class="nicdark_focus">
                <div class="nicdark_margin10">
                    ...
                    <p class="white">Lroin elit arcu, rutrum commodo, vehicula tempus, commodo a, risus. Curabitur nec arcu. Donec sollicitudin mi sit amet mauris. Nam elementum quam</p>
                    <div class="nicdark_space20"></div>
                    <a href="components-focus.php#" class="nicdark_btn white medium nicdark_bg_orangedark nicdark_shadow nicdark_radius">MORE</a>
               </div>
            </div>
        </div>

        <div class="grid grid_4 nomargin nicdark_bg_yellow nicdark_shadow nicdark_radius_right">
...
<section class="nicdark_section">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_12">
            <h3 class="subtitle greydark">WITHOUT MARGIN</h3>
            <div class="nicdark_space20"></div>
            <div class="nicdark_divider left small"><span class="nicdark_bg_blue nicdark_radius"></span></div>
            <div class="nicdark_space10"></div>
        </div>
                ...
                <div class="nicdark_textevidence nicdark_width_percentage25 nicdark_bg_blue nicdark_shadow nicdark_radius_left">
                    <div class="nicdark_textevidence">
                        <div class="nicdark_margin30">
                            <h2 class="white subtitle">COURSES</h2>
                       </div>
                        <i class="icon-search-1 nicdark_iconbg left extrabig blue nicdark_displaynone_ipadland nicdark_displaynone_ipadpotr"></i>
                    </div>
                </div>
                <div class="nicdark_textevidence nicdark_width_percentage25 nicdark_bg_yellow nicdark_shadow">
                    <div class="nicdark_textevidence">
                        <div class="nicdark_margin30">
                            <h2 class="white subtitle">PRICES</h2>
                       </div>
                        <i class="icon-search-1 nicdark_iconbg left extrabig yellow nicdark_displaynone_ipadland nicdark_displaynone_ipadpotr"></i>
                    </div>
                </div>
                <div class="nicdark_textevidence nicdark_width_percentage25 nicdark_bg_orange nicdark_shadow">
                    <div class="nicdark_textevidence">
                        <div class="nicdark_margin30">
                            <h2 class="white subtitle">TEACHERS</h2>
                       </div>
                        <i class="icon-search-1 nicdark_iconbg left extrabig orange nicdark_displaynone_ipadland nicdark_displaynone_ipadpotr"></i>
                    </div>
                </div>
                <div class="nicdark_textevidence nicdark_width_percentage25 nicdark_bg_green nicdark_shadow nicdark_radius_right">
                    <div class="nicdark_textevidence">
                        <div class="nicdark_margin30">
                            <h2 class="white subtitle">CONTACT</h2>
                       </div>
                        <i class="icon-search-1 nicdark_iconbg left extrabig green nicdark_displaynone_ipadland nicdark_displaynone_ipadpotr"></i>
                    </div>
                </div>
...
<section class="nicdark_section nicdark_bg_greydark">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_3 nomargin percentage">
            ...
            <a href="components-focus.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
            <a href="components-focus.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Baby</a>
            <a href="components-focus.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Kids</a>
            <a href="components-focus.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
            <a href="components-focus.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
            <a href="components-focus.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Baby</a>
            <a href="components-focus.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Kids</a>
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_6">
            <div class="nicdark_focus right nicdark_aligncenter_iphoneland nicdark_aligncenter_iphonepotr">
                <div class="nicdark_margin10">
                    <a href="components-focus.php#" class="nicdark_facebook nicdark_press right nicdark_btn_icon small nicdark_radius white"><i class="icon-facebook-1"></i></a>
                </div>
                <div class="nicdark_margin10">
                    <a href="components-focus.php#" class="nicdark_press right nicdark_btn_icon nicdark_bg_red nicdark_shadow small nicdark_radius white"><i class="icon-gplus"></i></a>
                </div>
                <div class="nicdark_margin10">
                    <a href="components-focus.php#" class="nicdark_press right nicdark_btn_icon nicdark_bg_blue nicdark_shadow small nicdark_radius white"><i class="icon-twitter-1"></i></a>
                </div>
                <div class="nicdark_margin10">
                    <a href="components-focus.php#start_nicdark_framework" class="nicdark_zoom nicdark_internal_link right nicdark_btn_icon nicdark_bg_greydark2 small nicdark_radius white"><i class="icon-up-outline"></i></a>
                </div>
            </div>
        </div>
