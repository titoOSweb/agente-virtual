            ...
            <div class="nicdark_container nicdark_clearfix">
                ...
                <div class="grid grid_6 right">
                    <div class="nicdark_focus right">
                        <h6 class="white">
                            <i class="icon-globe-alt-outline"></i>&nbsp;&nbsp;<a class="white nicdark_mpopup_window" href="single-teacher.php#nicdark_window">LANGUAGES</a>
                            &nbsp;&nbsp;&nbsp;&nbsp;<span class="grey">·</span>&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div class="grid grid_12 percentage">
                        ...
                        <nav>
                            <ul class="nicdark_menu nicdark_margin010 nicdark_padding50">
                                ...
                                <li class="orange">
                                    <a href="single-teacher.php#">PAGES</a>
                                    <ul class="sub-menu">
                                ...
                                <li class="blue nicdark_megamenu">
                                    <a href="single-teacher.php#">MEGA MENU</a>
                                    <ul class="sub-menu">
                                        ...
                                        <li class="mm_grid mm_grid_3">
                                            <a href="single-teacher.php#">DEDICATED PAGES</a>
                                            <ul class="sub-menu">
                                                <li><a href="single-course.php">Single Course</a></li>
                                                <li><a href="single-excursion.php">Single Excursion</a></li>
                                                <li><a href="single-event.php">Single Event</a></li>
                                        ...
                                        <li class="mm_grid mm_grid_3">
                                            <a href="single-teacher.php#">SPECIAL PAGES</a>
                                            <ul class="sub-menu">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_4">
            ...
            <div class="nicdark_focus center">
                <div class="nicdark_margin10">
                    <a title="YOUTUBE" href="single-teacher.php#" class="nicdark_press nicdark_tooltip right nicdark_btn_icon nicdark_bg_red nicdark_shadow small nicdark_radius white"><i class="icon-youtube-play"></i></a>
                </div>
                <div class="nicdark_margin10">
                    <a title="DRIBBBLE" href="single-teacher.php#" class="nicdark_press nicdark_tooltip right nicdark_btn_icon nicdark_bg_violet nicdark_shadow small nicdark_radius white"><i class="icon-dribbble-1"></i></a>
                </div>
                <div class="nicdark_margin10">
                    <a title="TWITTER" href="single-teacher.php#" class="nicdark_press nicdark_tooltip right nicdark_btn_icon nicdark_bg_blue nicdark_shadow small nicdark_radius white"><i class="icon-twitter-1"></i></a>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid_4">
            ...
            <div class="nicdark_progressbar nicdark_bg_grey nicdark_radius nicdark_shadow">
                <h5 class="nicdark_progressbar_title nicdark_bg_orange nicdark_radius nicdark_bg_orangedark_hover nicdark_shadow fade-left animate4 animated fadeInLeft" style="width:65%">
                    <span class="white nicdark_size_big"><i class="icon-dribbble"></i>&nbsp;&nbsp;&nbsp;SPORT · 65%</span>
                </h5>
            </div>
		...
		<div class="nicdark_slide1" >
			...
			<ul>
				...
				<li data-transition="slidehorizontal" data-slotamount="7" data-masterspeed="1000"  data-fstransition="fade" data-fsmasterspeed="1000" data-fsslotamount="7">
							<!-- MAIN IMAGE -->
							<img src="img/team/img10.jpg"  alt="video_forest"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">
							<!-- LAYERS -->
							...
							<div class="tp-caption tp-fade fadeout fullscreenvideo"
								...
								poster='img/team/img10.jpg' data-setup="{}">
...
<!--end section-->        </div>
        ...
        <div class="grid grid_4">
            ...
            <ul class="nicdark_list border">    
                <li class="nicdark_border_grey">
                    <p>DRAWING LESSON IN ALL CLASSES <a href="single-teacher.php#" class="nicdark_btn nicdark_bg_blue extrasmall nicdark_radius nicdark_shadow white right">9:00</a></p> 
                    <div class="nicdark_space15"></div>
                </li>

                <li class="nicdark_border_grey">
                    <div class="nicdark_space15"></div>
                    <p>BASIC NICE ART VIDEOS <a href="single-teacher.php#" class="nicdark_btn nicdark_bg_violet extrasmall nicdark_radius nicdark_shadow white right">11:00</a></p>   
                    <div class="nicdark_space15"></div>
                </li>
                    
                <li class="nicdark_border_grey">
                    <div class="nicdark_space15"></div>
                    <p>SOME WATER COLOR PRACTICE <a href="single-teacher.php#" class="nicdark_btn nicdark_bg_blue extrasmall nicdark_radius nicdark_shadow white right">14:00</a></p>   
                    <div class="nicdark_space15"></div>
                </li>

                <li class="nicdark_border_grey">
                    <div class="nicdark_space15"></div>
                    <p>WONDERFUL STENCIL TEST PAINTING <a href="single-teacher.php#" class="nicdark_btn nicdark_bg_violet extrasmall nicdark_radius nicdark_shadow white right">15:00</a></p>    
                    <div class="nicdark_space15"></div>
                </li>

                <li class="nicdark_border_grey">
                    <div class="nicdark_space15"></div>
                    <p>COLOR WITH FRUIT AND VEGETABLES <a href="single-teacher.php#" class="nicdark_btn nicdark_bg_blue extrasmall nicdark_radius nicdark_shadow white right">17:00</a></p>    
                </li> 
        ...
        <div class="grid grid_4">
            ...
            <div class="nicdark_space20"></div>
            <textarea class="nicdark_bg_grey nicdark_radius nicdark_shadow grey small subtitle" placeholder="MESSAGE" rows="9"></textarea>
            <div class="nicdark_space20"></div>
            <!--<input class="nicdark_btn nicdark_bg_blue small nicdark_shadow nicdark_radius white right" type="submit" value="SEND">-->
            <a href="submit-message.php" class="nicdark_mpopup_ajax nicdark_btn nicdark_bg_blue small nicdark_shadow nicdark_radius white nicdark_press right">SEND</a>
        </div>
...
<div id="nicdark_parallax_2_btns" class="nicdark_section nicdark_imgparallax nicdark_parallaxx_img8">
        ...
        <div class="nicdark_container nicdark_clearfix">
            ...
            <div class="grid grid_6 nicdark_aligncenter_iphoneland nicdark_aligncenter_iphonepotr">
                <a href="contact-1.php" class=" nicdark_btn nicdark_bg_blue medium nicdark_shadow nicdark_radius white nicdark_press"><i class="icon-file-pdf"></i>&nbsp;&nbsp;&nbsp;CURRICULUM</a>
            </div>
...
<section class="nicdark_section nicdark_bg_greydark">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_3 nomargin percentage">
            ...
            <a href="single-teacher.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
            <a href="single-teacher.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Baby</a>
            <a href="single-teacher.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Kids</a>
            <a href="single-teacher.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
            <a href="single-teacher.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
            <a href="single-teacher.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Baby</a>
            <a href="single-teacher.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Kids</a>
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_6">
            <div class="nicdark_focus right nicdark_aligncenter_iphoneland nicdark_aligncenter_iphonepotr">
                <div class="nicdark_margin10">
                    <a href="single-teacher.php#" class="nicdark_facebook nicdark_press right nicdark_btn_icon small nicdark_radius white"><i class="icon-facebook-1"></i></a>
                </div>
                <div class="nicdark_margin10">
                    <a href="single-teacher.php#" class="nicdark_press right nicdark_btn_icon nicdark_bg_red nicdark_shadow small nicdark_radius white"><i class="icon-gplus"></i></a>
                </div>
                <div class="nicdark_margin10">
                    <a href="single-teacher.php#" class="nicdark_press right nicdark_btn_icon nicdark_bg_blue nicdark_shadow small nicdark_radius white"><i class="icon-twitter-1"></i></a>
                </div>
                <div class="nicdark_margin10">
                    <a href="single-teacher.php#start_nicdark_framework" class="nicdark_zoom nicdark_internal_link right nicdark_btn_icon nicdark_bg_greydark2 small nicdark_radius white"><i class="icon-up-outline"></i></a>
                </div>
            </div>
        </div>
