            ...
            <div class="nicdark_container nicdark_clearfix">
                ...
                <div class="grid grid_6 right">
                    <div class="nicdark_focus right">
                        <h6 class="white">
                            <i class="icon-globe-alt-outline"></i>&nbsp;&nbsp;<a class="white nicdark_mpopup_window" href="excursions.php#nicdark_window">LANGUAGES</a>
                            &nbsp;&nbsp;&nbsp;&nbsp;<span class="grey">·</span>&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <nav>
                            <ul class="nicdark_menu nicdark_margin010 nicdark_padding50">
                                ...
                                <li class="blue nicdark_megamenu">
                                    <a href="excursions.php#">MEGA MENU</a>
                                    <ul class="sub-menu">
                                        ...
                                        <li class="mm_grid mm_grid_3">
                                            <a href="excursions.php#">DEDICATED PAGES</a>
                                            <ul class="sub-menu">
                                                <li><a href="single-course.php">Single Course</a></li>
                                                <li><a href="single-excursion.php">Single Excursion</a></li>
                                                <li><a href="single-event.php">Single Event</a></li>
                                        ...
                                        <li class="mm_grid mm_grid_3">
                                            <a href="excursions.php#">SPECIAL PAGES</a>
                                            <ul class="sub-menu">
    ...
    <div class="nicdark_filter greydark">
        ...
        <div class="nicdark_container nicdark_clearfix">
            ...
            <div class="grid grid_12">
                ...
                <div class="nicdark_space100"></div>
                <h1 class="white subtitle">ALL EXCURSIONS</h1>
                <div class="nicdark_space10"></div>
                <h3 class="subtitle white">THE BEST EXCURSIONS FOR YOU</h3>
                <div class="nicdark_space20"></div>
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_3">
            ...
            <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                ...
                <a title="9:00 AM" href="excursions.php#" class="nicdark_tooltip nicdark_btn_icon nicdark_bg_greydark white medium nicdark_radius_circle nicdark_absolute_left"><i class="icon-clock"></i></a>
                <a title="NEW YORK" href="excursions.php#" class="nicdark_tooltip nicdark_btn_icon nicdark_bg_greydark white medium nicdark_radius_circle nicdark_absolute_right"><i class="icon-location-outline"></i></a>

                <img alt="" src="img/excursions/img1.jpg">

                <div class="nicdark_textevidence nicdark_bg_greydark center">
                    <h4 class="white nicdark_margin20">DAY AT THE ZOO</h4>
                </div>

                 <div class="nicdark_textevidence nicdark_bg_blue center">
                    <h5 class="white nicdark_margin20">29 DECEMBER</h5>
                ...
                <div class="nicdark_textevidence center">
                    <div class="nicdark_margin20">
                        ...
                        <div class="nicdark_space20"></div>
                        <a href="single-excursion.php" class="nicdark_press white nicdark_btn nicdark_bg_blue medium nicdark_radius nicdark_shadow">MORE INFO</a>
                    </div>
                </div>
        ...
        <div class="grid grid_3">
            ...
            <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                ...
                <img alt="" src="img/excursions/img2.jpg">

                <div class="nicdark_textevidence nicdark_bg_greydark center">
                    <h4 class="white nicdark_margin20">VISIT THE PLANETARIUM</h4>
                </div>

                 <div class="nicdark_textevidence nicdark_bg_green center">
                    <h5 class="white nicdark_margin20">21 DECEMBER</h5>
                ...
                <div class="nicdark_textevidence center">
                    <div class="nicdark_margin20">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque tincidunt rutrum sapien.</p>
                        <div class="nicdark_space20"></div>
                        <a href="single-excursion.php" class="nicdark_press white nicdark_btn nicdark_bg_green medium nicdark_radius nicdark_shadow">MORE INFO</a>
                    </div>
                </div>
        ...
        <div class="grid grid_3">
            ...
            <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                ...
                <img alt="" src="img/excursions/img3.jpg">

                <div class="nicdark_textevidence nicdark_bg_greydark center">
                    <h4 class="white nicdark_margin20">ART MUSEUM</h4>
                </div>

                 <div class="nicdark_textevidence nicdark_bg_yellow center">
                    <h5 class="white nicdark_margin20">15 DECEMBER</h5>
                    <i class="icon-calendar nicdark_iconbg right medium yellow"></i>
                </div>
                ...
                <div class="nicdark_textevidence center">
                    <div class="nicdark_margin20">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque tincidunt rutrum sapien.</p>
                        <div class="nicdark_space20"></div>
                        <a href="single-excursion.php" class="nicdark_press white nicdark_btn nicdark_bg_yellow medium nicdark_radius nicdark_shadow">MORE INFO</a>
                    </div>
                </div>
        ...
        <div class="grid grid_3">
            ...
            <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                ...
                <div class="nicdark_textevidence nicdark_bg_greydark center">
                    <h4 class="white nicdark_margin20">CLASSIC CONCERT</h4>
                </div>

                 <div class="nicdark_textevidence nicdark_bg_orange center">
                    <h5 class="white nicdark_margin20">01 DECEMBER</h5>
                    <i class="icon-calendar nicdark_iconbg right medium orange"></i>
                </div>
                ...
                <div class="nicdark_textevidence center">
                    <div class="nicdark_margin20">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque tincidunt rutrum sapien.</p>
                        <div class="nicdark_space20"></div>
                        <a href="single-excursion.php" class="nicdark_press white nicdark_btn nicdark_bg_orange medium nicdark_radius nicdark_shadow">MORE INFO</a>
                    </div>
                </div>
        ...
        <div class="grid grid_3">
            ...
            <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                ...
                <img alt="" src="img/excursions/img5.jpg">

                <div class="nicdark_textevidence nicdark_bg_greydark center">
                    <h4 class="white nicdark_margin20">ART THERAPY</h4>
                </div>

                 <div class="nicdark_textevidence nicdark_bg_red center">
                    <h5 class="white nicdark_margin20">05 DECEMBER</h5>
                    <i class="icon-calendar nicdark_iconbg right medium red"></i>
                </div>
                ...
                <div class="nicdark_textevidence center">
                    <div class="nicdark_margin20">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque tincidunt rutrum sapien.</p>
                        <div class="nicdark_space20"></div>
                        <a href="single-excursion.php" class="nicdark_press white nicdark_btn nicdark_bg_red medium nicdark_radius nicdark_shadow">MORE INFO</a>
                    </div>
                </div>
        ...
        <div class="grid grid_3">
            ...
            <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                ...
                <div class="nicdark_textevidence nicdark_bg_greydark center">
                    <h4 class="white nicdark_margin20">WOODWORKINK</h4>
                </div>

                 <div class="nicdark_textevidence nicdark_bg_violet center">
                    <h5 class="white nicdark_margin20">30 NOVEMBER</h5>
                ...
                <div class="nicdark_textevidence center">
                    <div class="nicdark_margin20">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque tincidunt rutrum sapien.</p>
                        <div class="nicdark_space20"></div>
                        <a href="single-excursion.php" class="nicdark_press white nicdark_btn nicdark_bg_violet medium nicdark_radius nicdark_shadow">MORE INFO</a>
                    </div>
                </div>
        ...
        <div class="grid grid_3">
            ...
            <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                ...
                <img alt="" src="img/excursions/img7.jpg">

                <div class="nicdark_textevidence nicdark_bg_greydark center">
                    <h4 class="white nicdark_margin20">COOKING LESSONS</h4>
                </div>

                 <div class="nicdark_textevidence nicdark_bg_green center">
                    <h5 class="white nicdark_margin20">15 NOVEMBER</h5>
                    <i class="icon-calendar nicdark_iconbg right medium green"></i>
                </div>
        ...
        <div class="grid grid_3">
            ...
            <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                ...
                <img alt="" src="img/excursions/img8.jpg">

                <div class="nicdark_textevidence nicdark_bg_greydark center">
                    <h4 class="white nicdark_margin20">SEA EXCURSIONS</h4>
                </div>

                 <div class="nicdark_textevidence nicdark_bg_blue center">
                    <h5 class="white nicdark_margin20">05 NOVEMBER</h5>
                    <i class="icon-calendar nicdark_iconbg right medium blue"></i>
                </div>
...
<section class="nicdark_section nicdark_bg_greydark">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_3 nomargin percentage">
            ...
            <a href="excursions.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
            <a href="excursions.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Baby</a>
            <a href="excursions.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Kids</a>
            <a href="excursions.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
            <a href="excursions.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
            <a href="excursions.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Baby</a>
            <a href="excursions.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Kids</a>
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_6">
            <div class="nicdark_focus right nicdark_aligncenter_iphoneland nicdark_aligncenter_iphonepotr">
                <div class="nicdark_margin10">
                    <a href="excursions.php#" class="nicdark_facebook nicdark_press right nicdark_btn_icon small nicdark_radius white"><i class="icon-facebook-1"></i></a>
                </div>
                <div class="nicdark_margin10">
                    <a href="excursions.php#" class="nicdark_press right nicdark_btn_icon nicdark_bg_red nicdark_shadow small nicdark_radius white"><i class="icon-gplus"></i></a>
                </div>
                <div class="nicdark_margin10">
                    <a href="excursions.php#" class="nicdark_press right nicdark_btn_icon nicdark_bg_blue nicdark_shadow small nicdark_radius white"><i class="icon-twitter-1"></i></a>
                </div>
                <div class="nicdark_margin10">
                    <a href="excursions.php#start_nicdark_framework" class="nicdark_zoom nicdark_internal_link right nicdark_btn_icon nicdark_bg_greydark2 small nicdark_radius white"><i class="icon-up-outline"></i></a>
                </div>
            </div>
        </div>
