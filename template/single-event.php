            ...
            <div class="nicdark_container nicdark_clearfix">
                ...
                <div class="grid grid_6 right">
                    <div class="nicdark_focus right">
                        <h6 class="white">
                            <i class="icon-globe-alt-outline"></i>&nbsp;&nbsp;<a class="white nicdark_mpopup_window" href="single-event.php#nicdark_window">LANGUAGES</a>
                            &nbsp;&nbsp;&nbsp;&nbsp;<span class="grey">·</span>&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div class="grid grid_12 percentage">
                        ...
                        <nav>
                            <ul class="nicdark_menu nicdark_margin010 nicdark_padding50">
                                ...
                                <li class="orange">
                                    <a href="single-event.php#">PAGES</a>
                                    <ul class="sub-menu">
                                ...
                                <li class="blue nicdark_megamenu">
                                    <a href="single-event.php#">MEGA MENU</a>
                                    <ul class="sub-menu">
                                        ...
                                        <li class="mm_grid mm_grid_3">
                                            <a href="single-event.php#">DEDICATED PAGES</a>
                                            <ul class="sub-menu">
                                                <li><a href="single-course.php">Single Course</a></li>
                                                <li><a href="single-excursion.php">Single Excursion</a></li>
                                                <li><a href="single-event.php">Single Event</a></li>
                                        ...
                                        <li class="mm_grid mm_grid_3">
                                            <a href="single-event.php#">SPECIAL PAGES</a>
                                            <ul class="sub-menu">
    ...
    <div class="nicdark_filter greydark">
        ...
        <div class="nicdark_container nicdark_clearfix">
            ...
            <div class="grid grid_12">
                ...
                <div class="nicdark_space100"></div>
                <h1 class="white subtitle">EVENT: CHRISTMAS PARTY</h1>
                <div class="nicdark_space10"></div>
                <h3 class="subtitle white">DON'T MISS THE PARTY OF THE YEAR</h3>
                <div class="nicdark_space20"></div>
            ...
            <div class="nicdark_margin10">
                <div class="grid grid_3 percentage">
                    <div class="nicdark_margin10 nicdark_relative">
                        <a href="single-event.php#" class="nicdark_btn_icon nicdark_bg_green nicdark_shadow extrabig nicdark_radius_circle white nicdark_absolute nicdark_displaynone_ipadpotr"><i class="icon-location-outline"></i></a>
                ...
                <div class="grid grid_3 percentage">
                    <div class="nicdark_margin10 nicdark_relative">
                        <a href="single-event.php#" class="nicdark_btn_icon nicdark_bg_red extrabig nicdark_shadow nicdark_radius_circle white nicdark_absolute nicdark_displaynone_ipadpotr"><i class="icon-wristwatch"></i></a>
                ...
                <div class="grid grid_3 percentage">
                    <div class="nicdark_margin10 nicdark_relative">
                        <a href="single-event.php#" class="nicdark_btn_icon nicdark_bg_yellow extrabig nicdark_shadow nicdark_radius_circle white nicdark_absolute nicdark_displaynone_ipadpotr"><i class="icon-phone-outline"></i></a>
                ...
                <div class="grid grid_3 percentage">
                    <div class="nicdark_margin10 nicdark_relative">
                        <a href="single-event.php#" class="nicdark_btn_icon nicdark_bg_orange extrabig nicdark_shadow nicdark_radius_circle white nicdark_absolute nicdark_displaynone_ipadpotr"><i class="icon-download-outline"></i></a>
...
<section class="nicdark_section">
    ...
    <div class="nicdark_container nicdark_clearfix">
		...
		<div class="grid grid_6">
            <p><span class="white nicdark_dropcap nicdark_bg_red nicdark_radius nicdark_shadow">L</span>orem commodo lectus at sollicitudin elementum. Sed dolor turpis, condimentum sit amet maximus sit amet, rhoncus non turpis. Aenean convallis ac lorem et sodales. Sed dictum vel orci nec rhoncus. Donec quis porttitor arcu. Nulla ut justo quis augue commodo mattis nec vel ante.<br/><br/>Lorem commodo lectus at sollicitudin elementum. Sed dolor turpis, condimentum sit amet maximus sit amet, rhoncus non turpis. Aenean convallis ac lorem et sodales. Sed dictum vel orci nec rhoncus. Donec quis porttitor arcu. Nulla ut justo quis augue commodo mattis nec vel ante.<br/><br/>Lorem commodo lectus at sollicitudin elementum. Sed dolor turpis, condimentum sit amet maximus sit amet, rhoncus non turpis. Aenean convallis ac lorem et sodales. Sed dictum vel orci nec rhoncus. Donec quis porttitor arcu. Nulla ut justo quis augue commodo mattis nec vel ante.</p>
            <div class="nicdark_space10"></div>
            <div class="nicdark_focus center">
                <div class="nicdark_margin10">
                    <a title="ADD THIS EVENT" href="single-event.php#" class="nicdark_tooltip nicdark_btn nicdark_bg_red medium nicdark_shadow nicdark_radius white nicdark_margin10"><i class="icon-calendar-1"></i>&nbsp;&nbsp;&nbsp;I CALENDAR</a>
                </div>
                <div class="nicdark_margin10">
                    <a title="CONTACT US" href="single-event.php#" class="nicdark_tooltip nicdark_btn nicdark_bg_green medium nicdark_shadow nicdark_radius white nicdark_margin10"><i class="icon-info-outline"></i>&nbsp;&nbsp;&nbsp;INFORMATION</a>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid_6">
            ...
            <div class="nicdark_accordion">
                <h5 class="nicdark_accordion_header white big nicdark_bg_red nicdark_shadow nicdark_radius">EVENT ORGANIZATION</h5>
                <div class="nicdark_accordion_content">
                    <p>Mauris mauris ante, blandit et, ultrices a, susceros. Nam mi. Proin viverra leo ut odio.</p>
                </div>

                <h5 class="nicdark_accordion_header grey big nicdark_bg_grey nicdark_shadow nicdark_radius">PROGRAM OF THE EVENTS</h5>
                <div class="nicdark_accordion_content">
                    <p>Sed non urna. Donec et ante. Phasellus eu ligula. Vestibulum sit amet purus. Vivamus hendrerit, dolor at aliquet laoreet, mauris turpis porttitor velit, faucibus interdum tellus libero ac justo. Vivamus non quam. In suscipit faucibus urna. </p>
                </div>
                
                <h5 class="nicdark_accordion_header grey big nicdark_bg_grey nicdark_shadow nicdark_radius">THE MENU OF THE DAY</h5>
                <div class="nicdark_accordion_content">
                    <p>Nam enim risus, molestie et, porta ac, aliquam ac, risus. Quisque lobortis. Phasellus pellentesque purus in massa. Aenean in pede. Phasellus ac libero ac tellus pellentesque semper. Sed ac felis. Sed commodo, magna quis lacinia ornare, quam ante aliquam nisi, eu iaculis leo purus venenatis dui. </p>
                </div>

                <h5 class="nicdark_accordion_header grey big nicdark_bg_grey nicdark_shadow nicdark_radius">ENTERTAINMENT SHOW</h5>
                <div class="nicdark_accordion_content">
                    <p>Nam enim risus, molestie et, porta ac, aliquam ac, risus. Quisque lobortis. Phasellus pellentesque purus in massa. Aenean in pede. Phasellus ac libero ac tellus pellentesque semper. Sed ac felis. Sed commodo, magna quis lacinia ornare, quam ante aliquam nisi, eu iaculis leo purus venenatis dui. </p>
                </div>

                <h5 class="nicdark_accordion_header grey big nicdark_bg_grey nicdark_shadow nicdark_radius">LOREM IPSUM DOLOR</h5>
                <div class="nicdark_accordion_content">
                    <p>Nam enim risus, molestie et, porta ac, aliquam ac, risus. Quisque lobortis. Phasellus pellentesque purus in massa. Aenean in pede. Phasellus ac libero ac tellus pellentesque semper. Sed ac felis. Sed commodo, magna quis lacinia ornare, quam ante aliquam nisi, eu iaculis leo purus venenatis dui. </p>
                </div>
...
<section class="nicdark_section">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_12">
            ...
            <div class="nicdark_space20"></div>
            <h3 class="subtitle grey">LOOK WHAT HAPPENED LAST YEAR</h3>
            <div class="nicdark_space20"></div>
...
<section class="nicdark_section">
	...
	<div class="tp-banner-container">
		<div id="nicdark_slide1" class="tp-banner">
			...
			<ul>
				...
				<li data-transition="slidehorizontal" data-slotamount="7" data-masterspeed="1000"  data-fstransition="fade" data-fsmasterspeed="1000" data-fsslotamount="7">
							<!-- MAIN IMAGE -->
							<img src="img/slide/img5.jpg"  alt="video_forest"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">
							<!-- LAYERS -->
							...
							<div class="tp-caption tp-fade fadeout fullscreenvideo"
								...
								poster='img/slide/img5.jpg' data-setup="{}">
		...
		<div id="nicdark_slide2" class="tp-banner">
			...
			<ul>
				...
				<li data-transition="fade" data-slotamount="7" data-masterspeed="1000" data-saveperformance="on"  data-title="LESSON">
					<img src="img/slide/img6.jpg"  alt="" data-lazyload="img/slide/img6.jpg" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">
				</li>
				<!--end second-->

				<!--start first-->
				<li data-transition="fade" data-slotamount="7" data-masterspeed="1000" data-saveperformance="on"  data-title="FRIENDS">
					<img src="img/slide/img7.jpg"  alt="" data-lazyload="img/slide/img7.jpg" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">	
				</li>
				<!--end first-->
...
<!--end section-->       
        ...
        <div class="grid grid_12 nicdark_bg_grey nicdark_shadow nicdark_radius nicdark_relative">
            ...
            <a href="single-event.php#" class="nicdark_displaynone_iphoneland nicdark_displaynone_iphonepotr nicdark_btn_icon nicdark_bg_red  extrabig nicdark_radius_left white nicdark_absolute"><i class="icon-heart-2"></i></a>
                ...
                <div class="nicdark_margin1820 nicdark_marginleft100 nicdark_marginleft20_iphoneland nicdark_marginleft20_iphonepotr">
                    ...
                    <div class="nicdark_focus nicdark_width_percentage20">
                        <div class="nicdark_marginleft20 nicdark_disable_marginleft_iphoneland nicdark_disable_marginleft_iphonepotr">
                            <input class="nicdark_btn fullwidth nicdark_bg_red medium nicdark_shadow nicdark_radius white nicdark_press" type="submit" value="SEND"  >     
                        </div>
                    </div>
                </div>
            </div>
...
<section class="nicdark_section nicdark_bg_greydark">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_3 nomargin percentage">
            ...
            <a href="single-event.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
            <a href="single-event.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Baby</a>
            <a href="single-event.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Kids</a>
            <a href="single-event.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
            <a href="single-event.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
            <a href="single-event.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Baby</a>
            <a href="single-event.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Kids</a>
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_6">
            <div class="nicdark_focus right nicdark_aligncenter_iphoneland nicdark_aligncenter_iphonepotr">
                <div class="nicdark_margin10">
                    <a href="single-event.php#" class="nicdark_facebook nicdark_press right nicdark_btn_icon small nicdark_radius white"><i class="icon-facebook-1"></i></a>
                </div>
                <div class="nicdark_margin10">
                    <a href="single-event.php#" class="nicdark_press right nicdark_btn_icon nicdark_bg_red nicdark_shadow small nicdark_radius white"><i class="icon-gplus"></i></a>
                </div>
                <div class="nicdark_margin10">
                    <a href="single-event.php#" class="nicdark_press right nicdark_btn_icon nicdark_bg_blue nicdark_shadow small nicdark_radius white"><i class="icon-twitter-1"></i></a>
                </div>
                <div class="nicdark_margin10">
                    <a href="single-event.php#start_nicdark_framework" class="nicdark_zoom nicdark_internal_link right nicdark_btn_icon nicdark_bg_greydark2 small nicdark_radius white"><i class="icon-up-outline"></i></a>
                </div>
            </div>
        </div>
