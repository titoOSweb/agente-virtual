            ...
            <div class="nicdark_container nicdark_clearfix">
                ...
                <div class="grid grid_6 right">
                    <div class="nicdark_focus right">
                        <h6 class="white">
                            <i class="icon-globe-alt-outline"></i>&nbsp;&nbsp;<a class="white nicdark_mpopup_window" href="components-widgets.php#nicdark_window">LANGUAGES</a>
                            &nbsp;&nbsp;&nbsp;&nbsp;<span class="grey">·</span>&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div class="grid grid_12 percentage">
                        ...
                        <nav>
                            <ul class="nicdark_menu nicdark_margin010 nicdark_padding50">
                                ...
                                <li class="orange">
                                    <a href="components-widgets.php#">PAGES</a>
                                    <ul class="sub-menu">
                                ...
                                <li class="blue nicdark_megamenu">
                                    <a href="components-widgets.php#">MEGA MENU</a>
                                    <ul class="sub-menu">
                                        ...
                                        <li class="mm_grid mm_grid_3">
                                            <a href="components-widgets.php#">DEDICATED PAGES</a>
                                            <ul class="sub-menu">
                                                <li><a href="single-course.php">Single Course</a></li>
                                                <li><a href="single-excursion.php">Single Excursion</a></li>
                                                <li><a href="single-event.php">Single Event</a></li>
                                        ...
                                        <li class="mm_grid mm_grid_3">
                                            <a href="components-widgets.php#">SPECIAL PAGES</a>
                                            <ul class="sub-menu">
    ...
    <div class="nicdark_filter greydark">
        ...
        <div class="nicdark_container nicdark_clearfix">
            ...
            <div class="grid grid_12">
                ...
                <div class="nicdark_space100"></div>
                <h1 class="white subtitle">WIDGETS SOLUTIONS</h1>
                <div class="nicdark_space10"></div>
                <h3 class="subtitle white">BUILT YOUR CUSTOM WIDGET</h3>
                <div class="nicdark_space20"></div>
...
<section class="nicdark_section">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="nicdark_masonry_container">
            ...
            <div class="grid grid_4 nicdark_displaynone_ipadpotr nicdark_masonry_item">
                <div class="nicdark_calendar"></div>
            </div>
            ...
            <div class="grid grid_4 nicdark_masonry_item">
                ...
                <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                    ...
                    <ul class="nicdark_list border">
                        ...
                        <li class="nicdark_border_grey">
                            <div class="nicdark_margin20 nicdark_relative">
                            <img alt=""  class="nicdark_absolute nicdark_radius" style="width:60px;" src="img/footer/img3.jpg">
                            <div class="nicdark_activity nicdark_marginleft80">
                                <h5 class="grey">LOREM IPSUM</h5>                        
                                <div class="nicdark_space10"></div>
                                <p>Lorem ipsum dolor sit amet conse adip elit. Pellentesque tinci dolor sit.</p>
                        ...
                        <li class="nicdark_border_grey">
                            <div class="nicdark_margin20 nicdark_relative">
                            <img alt=""  class="nicdark_absolute nicdark_radius" style="width:60px;" src="img/footer/img2.jpg">
                            <div class="nicdark_activity nicdark_marginleft80">
                                <h5 class="grey">LOREM IPSUM</h5>                        
                                <div class="nicdark_space10"></div>
                                <p>Lorem ipsum dolor sit amet conse adip elit. Pellentesque tinci dolor sit.</p>
            ...
            <div class="grid grid_4 nicdark_masonry_item">
                ...
                <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                    <div class="nicdark_textevidence nicdark_bg_orange nicdark_radius_top">
                        <h4 class="white nicdark_margin20">TAG WIDGET</h4>
                        <i class="icon-tags-1 nicdark_iconbg right medium orange"></i>
                    </div>
                    <div class="nicdark_margin10">
                        <a href="components-widgets.php#" class="nicdark_btn nicdark_bg_grey2 small nicdark_shadow nicdark_radius grey subtitle nicdark_margin10">Teacher</a>
                        <a href="components-widgets.php#" class="nicdark_btn nicdark_bg_grey2 small nicdark_shadow nicdark_radius grey subtitle nicdark_margin10">Baby</a>
                        <a href="components-widgets.php#" class="nicdark_btn nicdark_bg_grey2 small nicdark_shadow nicdark_radius grey subtitle nicdark_margin10">Kids</a>
                        <a href="components-widgets.php#" class="nicdark_btn nicdark_bg_grey2 small nicdark_shadow nicdark_radius grey subtitle nicdark_margin10">Teacher</a>
                        <a href="components-widgets.php#" class="nicdark_btn nicdark_bg_grey2 small nicdark_shadow nicdark_radius grey subtitle nicdark_margin10">Teacher</a>
                        <a href="components-widgets.php#" class="nicdark_btn nicdark_bg_grey2 small nicdark_shadow nicdark_radius grey subtitle nicdark_margin10">Baby</a>
                        <a href="components-widgets.php#" class="nicdark_btn nicdark_bg_grey2 small nicdark_shadow nicdark_radius grey subtitle nicdark_margin10">Kids</a>
            ...
            <div class="grid grid_4 nicdark_masonry_item">
                ...
                <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                    <div class="nicdark_textevidence nicdark_bg_yellow nicdark_radius_top">
                        <h4 class="white nicdark_margin20">TEXT WIDGET</h4>
                        <i class="icon-text-width nicdark_iconbg right medium yellow"></i>
                    </div>
                    <div class="nicdark_margin20">
            ...
            <div class="grid grid_4 nicdark_masonry_item">
                ...
                <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                    <div class="nicdark_textevidence nicdark_bg_red nicdark_radius_top">
                        <h4 class="white nicdark_margin20">CONTACT WIDGET</h4>
                    ...
                    <div class="nicdark_margin20">
                        ...
                        <div class="nicdark_space20"></div>
                        <textarea class="nicdark_bg_grey2 nicdark_radius nicdark_shadow grey small subtitle" placeholder="MESSAGE"></textarea>
                        <div class="nicdark_space20"></div>
                        <!--<input class="nicdark_btn nicdark_bg_red medium nicdark_shadow nicdark_radius white" type="submit" value="SEND">-->
                        <a href="submit-message.php" class="nicdark_mpopup_ajax nicdark_btn nicdark_bg_red medium nicdark_shadow nicdark_radius white nicdark_press">SEND</a>
                    </div>
                </div>
            ...
            <div class="grid grid_4 nicdark_masonry_item">
                ...
                <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                    <div class="nicdark_textevidence nicdark_bg_red nicdark_radius_top">
                        <h4 class="white nicdark_margin20">DOCUMENT WIDGET</h4>
                        <i class="icon-download-outline nicdark_iconbg right medium red"></i>
                    </div>
                    <ul class="nicdark_list border">
                            
                        <li class="nicdark_border_grey">
                            <div class="nicdark_margin20 nicdark_relative">
                            <a href="components-widgets.php#" class="nicdark_btn_icon small nicdark_radius_circle red nicdark_absolute nicdark_border_red"><i class="icon-file-pdf"></i></a>
            ...
            <div class="grid grid_4 nicdark_masonry_item">
                ...
                <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                    <div class="nicdark_textevidence nicdark_bg_blue nicdark_radius_top">
                        <h4 class="white nicdark_margin20">EVENTS WIDGET</h4>
            ...
            <div class="grid grid_4 nicdark_masonry_item">
                ...
                <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                    <div class="nicdark_textevidence nicdark_bg_yellow nicdark_radius_top">
                        <h4 class="white nicdark_margin20">SEARCH WIDGET</h4>
                        <i class="icon-search-1 nicdark_iconbg right medium yellow"></i>
                    </div>
                    <div class="nicdark_margin20">
                        ...
                        <li class="nicdark_border_grey">
                            <div class="nicdark_margin20">
                                <div class="nicdark_activity">
                                    <p><i class="icon-right-open-outline"></i>&nbsp;Lorem ipsum dolor sit amet.</p>
                                </div>
                            </div>
                        </li>
...
<section class="nicdark_section nicdark_bg_greydark">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_3 nomargin percentage">
            ...
            <a href="components-widgets.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
            <a href="components-widgets.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Baby</a>
            <a href="components-widgets.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Kids</a>
            <a href="components-widgets.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
            <a href="components-widgets.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
            <a href="components-widgets.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Baby</a>
            <a href="components-widgets.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Kids</a>
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_6">
            <div class="nicdark_focus right nicdark_aligncenter_iphoneland nicdark_aligncenter_iphonepotr">
                <div class="nicdark_margin10">
                    <a href="components-widgets.php#" class="nicdark_facebook nicdark_press right nicdark_btn_icon small nicdark_radius white"><i class="icon-facebook-1"></i></a>
                </div>
                <div class="nicdark_margin10">
                    <a href="components-widgets.php#" class="nicdark_press right nicdark_btn_icon nicdark_bg_red nicdark_shadow small nicdark_radius white"><i class="icon-gplus"></i></a>
                </div>
                <div class="nicdark_margin10">
                    <a href="components-widgets.php#" class="nicdark_press right nicdark_btn_icon nicdark_bg_blue nicdark_shadow small nicdark_radius white"><i class="icon-twitter-1"></i></a>
                </div>
                <div class="nicdark_margin10">
                    <a href="components-widgets.php#start_nicdark_framework" class="nicdark_zoom nicdark_internal_link right nicdark_btn_icon nicdark_bg_greydark2 small nicdark_radius white"><i class="icon-up-outline"></i></a>
                </div>
            </div>
        </div>
