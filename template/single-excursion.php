            ...
            <div class="nicdark_container nicdark_clearfix">
                ...
                <div class="grid grid_6 right">
                    <div class="nicdark_focus right">
                        <h6 class="white">
                            <i class="icon-globe-alt-outline"></i>&nbsp;&nbsp;<a class="white nicdark_mpopup_window" href="single-excursion.php#nicdark_window">LANGUAGES</a>
                            &nbsp;&nbsp;&nbsp;&nbsp;<span class="grey">·</span>&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div class="grid grid_12 percentage">
                        ...
                        <nav>
                            <ul class="nicdark_menu nicdark_margin010 nicdark_padding50">
                                ...
                                <li class="orange">
                                    <a href="single-excursion.php#">PAGES</a>
                                    <ul class="sub-menu">
                                ...
                                <li class="blue nicdark_megamenu">
                                    <a href="single-excursion.php#">MEGA MENU</a>
                                    <ul class="sub-menu">
                                        ...
                                        <li class="mm_grid mm_grid_3">
                                            <a href="single-excursion.php#">DEDICATED PAGES</a>
                                            <ul class="sub-menu">
                                                <li><a href="single-course.php">Single Course</a></li>
                                                <li><a href="single-excursion.php">Single Excursion</a></li>
                                                <li><a href="single-event.php">Single Event</a></li>
                                        ...
                                        <li class="mm_grid mm_grid_3">
                                            <a href="single-excursion.php#">SPECIAL PAGES</a>
                                            <ul class="sub-menu">
...
<section class="nicdark_section">
    ...
    <div class="nicdark_container nicdark_clearfix">
		...
		<div class="grid grid_8">
            ...
            <div class="nicdark_tab">
                ...
                <ul class="nicdark_tabslist">
                    <li><a title="THIS IS A TOOLTIP" href="single-excursion.php#tabs-1" class="nicdark_tooltip nicdark_btn nicdark_bg_violet medium nicdark_radius_top white">DESCRIPTION</a></li>
                    <li><a href="single-excursion.php#tabs-2" class="nicdark_btn nicdark_bg_green medium nicdark_radius_top white">THE TOUR</a></li>
                    <li><a href="single-excursion.php#tabs-3" class="nicdark_btn nicdark_bg_blue medium nicdark_radius_top white">WHAT DO YOU NEED ?</a></li>
                    <li><a href="single-excursion.php#tabs-4" class="nicdark_btn nicdark_bg_yellow medium nicdark_radius_top white">INCLUDED</a></li>
                </ul>
        ...
        <div class="grid grid_4">
            ...
            <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                <div class="nicdark_margin20 nicdark_relative">
                        <a href="single-excursion.php#" class="nicdark_displaynone_ipadpotr nicdark_btn_icon nicdark_bg_blue extrabig nicdark_radius_circle white nicdark_absolute nicdark_shadow"><i class="icon-location-outline"></i></a>
            ...
            <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                <div class="nicdark_margin20 nicdark_relative">
                        <a href="single-excursion.php#" class="nicdark_displaynone_ipadpotr nicdark_btn_icon nicdark_bg_green extrabig nicdark_radius_circle white nicdark_absolute nicdark_shadow"><i class="icon-wristwatch"></i></a>
                        <div class="nicdark_activity nicdark_marginleft100 nicdark_disable_marginleft_ipadpotr">
            ...
            <div class="nicdark_archive1 nicdark_bg_greydark nicdark_radius nicdark_shadow">
                <div class="nicdark_margin20 nicdark_relative">
                        <a href="single-excursion.php#" class="nicdark_displaynone_ipadpotr nicdark_btn_icon nicdark_bg_yellow extrabig nicdark_radius_circle white nicdark_absolute nicdark_shadow"><i class="icon-file-pdf"></i></a>
                        <div class="nicdark_activity nicdark_marginleft100 nicdark_disable_marginleft_ipadpotr">
            ...
            <div class="nicdark_archive1 nicdark_bg_red nicdark_radius nicdark_shadow">
                <div class="nicdark_margin20 nicdark_relative">
                        <a href="single-excursion.php#" class="nicdark_displaynone_ipadpotr nicdark_btn_icon nicdark_bg_reddark extrabig nicdark_radius_circle white nicdark_absolute nicdark_shadow"><i class="icon-download-outline"></i></a>
                        <div class="nicdark_activity nicdark_marginleft100 nicdark_disable_marginleft_ipadpotr">
            ...
            <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                ...
                <ul class="nicdark_list border">
                    ...
                    <li class="nicdark_border_grey">
                        <div class="nicdark_margin20 nicdark_relative">
                        <a href="single-excursion.php#" class="nicdark_btn_icon small nicdark_radius_circle grey nicdark_absolute nicdark_border_grey2"><i class="icon-clock"></i></a>
                        <div class="nicdark_activity nicdark_marginleft60">
                            <h5 class="grey">MEETING IN TIMES SQUARE</h5>                        
                            <div class="nicdark_space10"></div>
                            <p>Lorem ipsum dolor sit amet conse adip elit. Pellentesque tinci dolor sit amet. Pellentesque tinci dolor sit amet</p>
                        </div></div>
                    </li>
                    <li class="nicdark_border_grey">
                        <div class="nicdark_margin20 nicdark_relative">
        ...
        <div class="grid grid_12 nicdark_bg_grey nicdark_shadow nicdark_radius nicdark_relative">
            ...
            <a href="single-excursion.php#" class="nicdark_displaynone_iphoneland nicdark_displaynone_iphonepotr nicdark_btn_icon nicdark_bg_blue  extrabig nicdark_radius_left white nicdark_absolute"><i class="icon-pencil-2"></i></a>
            ...
            <div class="nicdark_textevidence">
                <div class="nicdark_margin1820 nicdark_marginleft100 nicdark_marginleft20_iphoneland nicdark_marginleft20_iphonepotr">
                    ...
                    <div class="nicdark_focus nicdark_width_percentage25">
                        <div class="nicdark_marginleft20 nicdark_disable_marginleft_iphoneland nicdark_disable_marginleft_iphonepotr">
                            <input class="nicdark_btn fullwidth nicdark_bg_blue medium nicdark_shadow nicdark_radius white nicdark_press" type="submit" value="SEND">     
                        </div>
                    </div>
                </div>
            </div>
...
<section class="nicdark_section nicdark_bg_greydark">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_3 nomargin percentage">
            ...
            <a href="single-excursion.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
            <a href="single-excursion.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Baby</a>
            <a href="single-excursion.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Kids</a>
            <a href="single-excursion.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
            <a href="single-excursion.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
            <a href="single-excursion.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Baby</a>
            <a href="single-excursion.php#" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Kids</a>
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_6">
            <div class="nicdark_focus right nicdark_aligncenter_iphoneland nicdark_aligncenter_iphonepotr">
                <div class="nicdark_margin10">
                    <a href="single-excursion.php#" class="nicdark_facebook nicdark_press right nicdark_btn_icon small nicdark_radius white"><i class="icon-facebook-1"></i></a>
                </div>
                <div class="nicdark_margin10">
                    <a href="single-excursion.php#" class="nicdark_press right nicdark_btn_icon nicdark_bg_red nicdark_shadow small nicdark_radius white"><i class="icon-gplus"></i></a>
                </div>
                <div class="nicdark_margin10">
                    <a href="single-excursion.php#" class="nicdark_press right nicdark_btn_icon nicdark_bg_blue nicdark_shadow small nicdark_radius white"><i class="icon-twitter-1"></i></a>
                </div>
                <div class="nicdark_margin10">
                    <a href="single-excursion.php#start_nicdark_framework" class="nicdark_zoom nicdark_internal_link right nicdark_btn_icon nicdark_bg_greydark2 small nicdark_radius white"><i class="icon-up-outline"></i></a>
                </div>
            </div>
        </div>
